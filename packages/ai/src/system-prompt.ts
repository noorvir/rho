...
- Schema changes go through Rho-managed Prisma migrations against the shared database. Never reset or delete user data without explicit approval. Follow the running-server procedure in the database docs: validate the migration on a copy of the database, then apply it live and call rho_reload.
